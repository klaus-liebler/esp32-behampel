...
#if CONFIG_NETWORK_CONNECT_ETHERNET
#include "esp_eth.h"
#if CONFIG_ETH_USE_SPI_ETHERNET
#include "driver/spi_master.h"
#endif // CONFIG_ETH_USE_SPI_ETHERNET
#endif // CONFIG_NETWORK_CONNECT_ETHERNET
#include "esp_log.h"
#include "esp_netif.h"
...
#ifdef CONFIG_NETWORK_CONNECT_IPV6
#define MAX_IP6_ADDRS_PER_NETIF (5)
#define NR_OF_IP_ADDRESSES_TO_WAIT_FOR (s_active_interfaces*2)

#if defined(CONFIG_NETWORK_CONNECT_IPV6_PREF_LOCAL_LINK)
#define EXAMPLE_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_LINK_LOCAL
#elif defined(CONFIG_NETWORK_CONNECT_IPV6_PREF_GLOBAL)
#define EXAMPLE_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_GLOBAL
#elif defined(CONFIG_NETWORK_CONNECT_IPV6_PREF_SITE_LOCAL)
#define EXAMPLE_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_SITE_LOCAL
#elif defined(CONFIG_NETWORK_CONNECT_IPV6_PREF_UNIQUE_LOCAL)
#define EXAMPLE_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_UNIQUE_LOCAL
#endif // if-elif CONFIG_NETWORK_CONNECT_IPV6_PREF_...

#else
#define NR_OF_IP_ADDRESSES_TO_WAIT_FOR (s_active_interfaces)
#endif

#define EXAMPLE_DO_CONNECT CONFIG_NETWORK_CONNECT_WIFI || CONFIG_NETWORK_CONNECT_ETHERNET
...
#if CONFIG_NETWORK_CONNECT_WIFI && CONFIG_NETWORK_CONNECT_ETHERNET
...
esp_err_t connectBlocking(void)
{
#if EXAMPLE_DO_CONNECT
...
#ifdef CONFIG_NETWORK_CONNECT_WIFI
...
static esp_netif_t *wifi_start(void)
{
    ...
    char hostname[32];
    sprintf(hostname, "behampel-%02X%02X%02X", mac[3], mac[4], mac[5]);
...
#ifdef CONFIG_NETWORK_CONNECT_ETHERNET
...
static esp_netif_t *eth_start(void)
{
    ...
    ESP_ERROR_CHECK(spi_bus_initialize(CONFIG_NETWORK_ETH_SPI_HOST, &buscfg, 1));
...
#endif
#elif CONFIG_NETWORK_USE_OPENETH
